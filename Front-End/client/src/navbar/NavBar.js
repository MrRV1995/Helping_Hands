...
const NavBar = () => {
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item active">
      ...
      <li class="nav-item active">
        <a class="nav-link" onclick={redirectlogin} href="\login">Admin Login<span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item active">
        <a class="nav-link" onclick={redirectdologin} href="\complogin">NGO Login<span class="sr-only">(current)</span></a>
      </li>
