...
function compreg() {
 ...
 // const status = "Active";
  ...
  const validate = () => {
    ...
    if (Name === "") {
      sweetalert("Error", "Please enter Company  Name", "error");
      return false;
      // } else if (!isNaN(Name)) {
  ...
  const addNewUser = async () => {
    const newuser = {
      ...
      cemail: Email,
      cpass: Pass,
      // ccitypincode: Citypin,
      caddr:City,
      status: status,
      cId: Role,
    };

  //   let url = "http://localhost:8000/companies/registerUser";
  ...
  //   const response = await axios.post("http://localhost:8000/checkEmail", user);
    ...
    <div className="card-body py-5 px-md-5">
      ...
      <div className="row d-flex justify-content-center">
        <div className="col-lg-8">
          <h2 className="fw-bold mb-5">Sign up For Company</h2>
          <form>
